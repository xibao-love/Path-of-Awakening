...
&nbsp;   \* 首次拾取未被拿过的废品，使其\*\*价值增加 50%\*\*。

&nbsp;   \* \*\*代价：\*\* 你的最大生命值永久降至 \*\*20%\*\*。一碰就碎！

\* \*\*名刀司命 (MingDaoSkill)\*\*

&nbsp;   \* 抵挡致命伤害并保留 1 点生命（每局限 1 次）。触发后获 5s 爆发移速。

\* \*\*亡者遗怨 (DeadResentmentSkill)\*\*

&nbsp;   \* 死后化身自爆卡车。对周围 10m 造成爆炸伤害（和队友一起上天吧）。

\* \*\*平稳着陆 (SmoothLandingSkill)\*\*

&nbsp;   \* 从 5m 以上高处坠落，并获得 5s 加速且无视体力。随后虚弱3秒，冷却3分钟。。
...
2\. \[LethalCompanyInputUtils](https://thunderstore.io/c/lethal-company/p/Rune580/LethalCompany\_InputUtils/)
